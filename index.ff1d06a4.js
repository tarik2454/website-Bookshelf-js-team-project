let e;function t(e,t,n,o){Object.defineProperty(e,t,{get:n,set:o,enumerable:!0,configurable:!0})}function n(e){return e&&e.__esModule?e.default:e}var o="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},r={},a=o.parcelRequirea837;null==a&&((a=function(e){if(e in i)return i[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return i[e]=n,t.call(n.exports,n,n.exports),n.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){r[e]=t},o.parcelRequirea837=a),a.register("kyEFX",function(e,n){"use strict";t(e.exports,"register",function(){return o},function(e){return o=e}),t(e.exports,"resolve",function(){return i},function(e){return i=e});var o,i,r={};o=function(e){for(var t=Object.keys(e),n=0;n<t.length;n++)r[t[n]]=e[t[n]]},i=function(e){var t=r[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),a("kyEFX").register(JSON.parse('{"kROXL":"index.ff1d06a4.js","lp5u4":"sprite.706b91f7.svg","3d7qD":"index.f6d33a9d.js","1HyLC":"index.5c2819ad.css","hZ4qx":"index.91df488e.js"}')),a("dWN8B");var l=(a("2sKPt"),a("2sKPt"));function s(e){let{list_name:t,books:n}=e,o=n.map(({title:e,author:t,book_image:n,_id:o})=>`
  ...
  `}const c=document.querySelector(".cont-section"),d=document.querySelector(".loader-inner"),u=new l.FetchBook;async function f(e){try{d.style.display="flex",c.innerHTML="";let t=await u.fetchElement("/top-books");!function(e,t){let n=function(e,t){let n=`<div class="container grid-wrapper">
      ...
      </h2>`,o=e.map(({list_name:e,books:n})=>({list_name:e,books:n.slice(0,t)}));return`${n}${o.map(s).join("")}`}(e,t);c.insertAdjacentHTML("beforeend",n)}(t,e)}catch(e){console.log(e)}finally{d.style.display="none"}}function m(){let t=window.innerWidth;c.addEventListener("click",function(e){let t=e.target.dataset.listname;y(t)}),e&&clearTimeout(e),e=setTimeout(()=>{window.removeEventListener("resize",m),t>=1440?f(5):t>=768?f(3):f(1),window.addEventListener("resize",m)},300)}m(),window.addEventListener("resize",m);const v=document.querySelector(".aside-list"),p=document.querySelector(".cont-section"),h=document.querySelector(".categories-list-name"),g=document.querySelector(".loader-inner"),b=new l.FetchBook;function y(e){void 0!==e&&(!function(e){let t=document.querySelectorAll(".aside-link");h.classList.remove("activ-name"),t.forEach(t=>{t.classList.remove("activ-name"),t.textContent===e&&t.classList.add("activ-name")})}(e),g.style.display="flex",b.fetchElement(`/category?category=${e}`).then(t=>{let n=t.map(e=>(function(e){let{book_image:t,title:n,author:o,_id:i}=e;return`
    <li class="cards-item">
  ...
  <ul class="card-list">${e}</ul>
      ...
      </ul>`;F.innerHTML=d,function e(t){let n=JSON.parse(localStorage.getItem("bookList")),o=document.querySelector(".btn-container");if(Array.isArray(n)&&n||(n=[]),n.includes(t)){o.innerHTML=`<button class="modal-active-btn js-removeBtn" data-id="${t}">
      remove from the shopping list
    </button>
    <p class="modal-congratulations-text">
      Сongratulations! You have added the book to the shopping list. To delete,
      press the button “Remove from the shopping list”.
    </p>`;let i=document.querySelector(".js-removeBtn");i.addEventListener("click",function o(i){localStorage.setItem("bookList",JSON.stringify(n.filter(e=>e!==t))),e(t),i.currentTarget.removeEventListener("click",o),(0,j.addToFierbase)(),H()})}else{o.innerHTML=`<button class="modal-active-btn-add js-addBtn" data-id="${t}">
      add to shopping list
    </button>`;let i=document.querySelector(".js-addBtn");i.addEventListener("click",function o(i){n.push(t),localStorage.setItem("bookList",JSON.stringify(n)),e(t),i.currentTarget.removeEventListener("click",o),(0,j.addToFierbase)(),H()})}}(e.target.dataset.id)}M.addEventListener("click",B),a("iiT47");var N={},R={},z={};z=function(e){var t=typeof e;return null!=e&&("object"==t||"function"==t)};var C={},D={},W={};W="object"==typeof o&&o&&o.Object===Object&&o;var X="object"==typeof self&&self&&self.Object===Object&&self;D=W||X||Function("return this")(),C=function(){return D.Date.now()};var I={},J={},P={},U=/\s/;P=function(e){for(var t=e.length;t--&&U.test(e.charAt(t)););return t};var Y=/^\s+/;J=function(e){return e?e.slice(0,P(e)+1).replace(Y,""):e};var K={},G={},Q={};Q=D.Symbol;var Z={},V=Object.prototype,ee=V.hasOwnProperty,et=V.toString,en=Q?Q.toStringTag:void 0;Z=function(e){var t=ee.call(e,en),n=e[en];try{e[en]=void 0;var o=!0}catch(e){}var i=et.call(e);return o&&(t?e[en]=n:delete e[en]),i};var eo={},ei=Object.prototype.toString;eo=function(e){return ei.call(e)};var er=Q?Q.toStringTag:void 0;G=function(e){return null==e?void 0===e?"[object Undefined]":"[object Null]":er&&er in Object(e)?Z(e):eo(e)};var ea={};ea=function(e){return null!=e&&"object"==typeof e},K=function(e){return"symbol"==typeof e||ea(e)&&"[object Symbol]"==G(e)};var el=0/0,es=/^[-+]0x[0-9a-f]+$/i,ec=/^0b[01]+$/i,ed=/^0o[0-7]+$/i,eu=parseInt;I=function(e){if("number"==typeof e)return e;if(K(e))return el;if(z(e)){var t="function"==typeof e.valueOf?e.valueOf():e;e=z(t)?t+"":t}if("string"!=typeof e)return 0===e?e:+e;e=J(e);var n=ec.test(e);return n||ed.test(e)?eu(e.slice(2),n?2:8):es.test(e)?el:+e};var ef=Math.max,em=Math.min;R=function(e,t,n){var o,i,r,a,l,s,c=0,d=!1,u=!1,f=!0;if("function"!=typeof e)throw TypeError("Expected a function");function m(t){var n=o,r=i;return o=i=void 0,c=t,a=e.apply(r,n)}function v(e){var n=e-s,o=e-c;return void 0===s||n>=t||n<0||u&&o>=r}function p(){var e,n,o,i=C();if(v(i))return h(i);l=setTimeout(p,(e=i-s,n=i-c,o=t-e,u?em(o,r-n):o))}function h(e){return(l=void 0,f&&o)?m(e):(o=i=void 0,a)}function g(){var e,n=C(),r=v(n);if(o=arguments,i=this,s=n,r){if(void 0===l)return c=e=s,l=setTimeout(p,t),d?m(e):a;if(u)return clearTimeout(l),l=setTimeout(p,t),m(s)}return void 0===l&&(l=setTimeout(p,t)),a}return t=I(t)||0,z(n)&&(d=!!n.leading,r=(u="maxWait"in n)?ef(I(n.maxWait)||0,t):r,f="trailing"in n?!!n.trailing:f),g.cancel=function(){void 0!==l&&clearTimeout(l),c=0,o=s=i=l=void 0},g.flush=function(){return void 0===l?a:h(C())},g},N=function(e,t,n){var o=!0,i=!0;if("function"!=typeof e)throw TypeError("Expected a function");return z(n)&&(o="leading"in n?!!n.leading:o,i="trailing"in n?!!n.trailing:i),R(e,t,{leading:o,maxWait:t,trailing:i})};const ev=document.querySelector(".scroll-to-top"),ep=n(N)(function(){let e=window.scrollY,t=document.documentElement.clientHeight;function n(){window.scrollTo({top:0,behavior:"smooth"})}e>=t?(ev.addEventListener("click",n),ev.classList.remove("unvisually")):(ev.classList.add("unvisually"),ev.addEventListener("click",n))},500);window.addEventListener("scroll",ep),a("lohXh");
//# sourceMappingURL=index.ff1d06a4.js.map
